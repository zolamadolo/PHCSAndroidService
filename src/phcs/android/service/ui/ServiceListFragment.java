...
public class ServiceListFragment extends ListFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setListAdapter(new ArrayAdapter<ServiceContent.UIItem>(getActivity(),
				android.R.layout.simple_list_item_activated_1,
				android.R.id.text1, ServiceContent.ITEMS));
	}
	...
	public void onListItemClick(ListView listView, View view, int position,
		...
		mCallbacks.onItemSelected(ServiceContent.ITEMS.get(position).id);
	}
